                ...
                <table class="table">
                    ...
                    <?php foreach($event->getAllTeams() as $team) { ?>
                        <tr>
                            ...
                            <!-- team name -->
                            <td class="br bb">
                                <h5 class="text-uppercase m-0" style="margin-bottom: 4px !important;"><?= $team->getName() ?></h5>
                                <p class="m-0 p-0" style="line-height: 1"><small class="m-0 fw-bold opacity-75"><?= $team->getLocation() ?></small></p>
                                <p class="m-0 p-0" style="line-height: 1"><small class="m-0"><?= $team->parseMetaData() ?></small></p>
                            </td>
                ...
                <div class="row justify-content-center pt-5">
                    ...
                    <div class="col-2 col-sm-2 col-md-2">
                        <div class="h-100 d-flex justify-content-center align-items-center">
                            <img src="/missbato-scr/aclc-iriga.png" alt="ACLC College of Iriga (Official Tabulator)" style="width: 156px;"/>
                        </div>
                    </div>
                </div>
            </div>
